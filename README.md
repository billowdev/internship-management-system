...
<h3 align="center">internship-management-system</h3>
...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `lacakp`, `internship-management-system`, `twitter_handle`, `lacakp`, `email_client`, `email`, `internship-management-system`, `project_description`
